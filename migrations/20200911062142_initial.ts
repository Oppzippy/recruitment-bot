...
export async function up(knex: Knex): Promise<void> {
	await knex.schema.createTable("recruitment_invite_link", (table) => {
...
export async function down(knex: Knex): Promise<void> {
	await knex.schema.dropTable("recruitment_invite_link");
	await knex.schema.dropTable("accepted_recruitment_invite_link");
}
